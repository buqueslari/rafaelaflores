        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="about-us-content">
              <h3 className="title wow fadeInUp">Rafaela Flores – Offering rare and beautiful items worldwide</h3>
